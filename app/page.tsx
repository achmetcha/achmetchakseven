    ...
    <section className="w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
        ...
        <div className="lg:col-span-7 flex flex-col gap-10">
          ...
          {/* Blog Posts (Hierhin verschoben für bessere Balance) */}
          <div>
      ...
      {/* --- UNTERER BEREICH: SKILLS (Waagerecht) --- */}
      <div className="w-full">
        <h2 className="text-2xl font-bold mb-6 tracking-tight">Technische Expertise</h2>
        
        {/* Grid: 1 Spalte auf Mobile, 3 Spalten auf Desktop */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="p-5 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900 hover:shadow-md transition-all">
              ...
              <div className="flex flex-col justify-between h-full"> {/* Layout angepasst für schmale Karte */}
                <p className="text-xs text-neutral-500 mb-3">
