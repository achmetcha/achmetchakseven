...
Der Quellcode für das [Web-Projekt](https://github.com/achmetcha/digit-recognizer-py) ist ebenfalls Teil dieses Portfolios. Schau dir gerne die Implementierung der `DigitRecognizer`-Komponente an, um mehr Details zum Preprocessing zu erfahren.